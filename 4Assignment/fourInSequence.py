# Ryan Huckaby            10-21-2025
# Assignment #4
#
# Description: This code is of a game where to win a player must place four of their items (X's or O's) within a row!
#              The game supports one-player (vs. AI) and two-player modes.
#
...
def main():
    ...
    while running:
        ...
        if choice == "p":
            ...
            print(
                "RULES FOR THE GAME (you must follow):\n"
                "- The user will choose whether they want to play with 1 or two players.\n"
                "    - A one player game has the user play against the computer.\n"
                "       - The computer will know when and how to block, win, and place.. Don't think it will be easy.\n"
                "    - A two player game has two users take turns against each other until a winner.\n"
                "- Each player takes turns 'dropping' (more like inserting in our case...) their 'items' into the board.\n"
                "    - The goal is for one player to connect four pieces in any direction, up, down, left, right, diagonally, etc...\n"
                "- The game ends when one player has, well... FOUR IN SEQUENCE! (Hence the name of the game)\n"
            )
        elif choice == "q":
            print("Goodbye!")
            running = False
